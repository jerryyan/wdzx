    ...
    <body>
        <div id="header">
            ...
            if (isset($_SESSION["username"]) && time() > $_SESSION['username'] + 1200) {
                echo "<div id='admin_login' ><span>当前管理员：{$_SESSION['username']}</span>|<a href='admin_list.php'>导航列表</a>|<a href='admin_submit_list.php'>审核列表</a>|<a href='admin_problem.php'>问题平台列表</a><a id='logout' href='login_db.php?action=logout'>注销</a></div>";
            } else {
