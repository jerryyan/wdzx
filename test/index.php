  ...
  <div class="content">
    ...
    <div class="left conlist" id="level_0">
      ...
      <ul class="conlisttext">
        ...
        <li><a href="<?php echo $dh['url'];?>" target="_blank"><font size="10px;"><?php echo $dh['name'];?></font></a></li>
        <?php }?>
      </ul>
      <div class="clear"></div>
    </div>
    ...
    <div class="left conlist" id="level_1" style="display:none;">
      <ul class="conlisttext">
        ...
        <li><a href="<?php echo $dh['url'];?>" target="_blank"><?php echo $dh['name'];?></a></li>
        <?php }?>
      </ul>
      <div class="clear"></div>
    </div>
    ...
    <div class="left conlist" id="level_5" style="display:none;">
      <ul class="conlisttext">
        <?php foreach ($dh_list as $dh){if($dh["level"] != 5){continue;}?>
        <li><a href="<?php echo $dh['url'];?>" target="_blank"><?php echo $dh['name'];?></a></li>
        <?php }?>
      </ul>
      <div class="clear"></div>
